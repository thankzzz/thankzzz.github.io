            ...
            <div className="row">
                ...
                <div className="col-lg-4 col-md-6 col-sm-6">
                    <div className="footer__address">
                        <h5>Contact Us</h5>
                        <ul>
                            <li style={{width:'280px'}}><i className="fa fa-map-marker"></i> Kompleks Industri Multiguna <br/> &nbsp; &nbsp; &nbsp; &nbsp;  Jl. Selayar no 6 KIM II-Mabar,<br/>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;Percut Sei Tuan Deli Serdang</li>
                            <li><i className="fa fa-phone"></i><span >(061) 6871589/6871592</span></li>
                            <li><i className="fa fa-envelope"></i> sales@hansonprima.com</li>
                        </ul>
                    </div>
                </div>
